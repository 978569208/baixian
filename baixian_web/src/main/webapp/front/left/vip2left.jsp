...
<base href="<%=basepath %>" />
    ...
    $(function(){
    	...
    	$("#suppliers").click(function(){
    		$("#lefra").attr("src","front/right/suppliers.jsp");
    		
    	});
    	$("#procurement").click(function(){
    		$("#lefra").attr("src","front/right/procurement.jsp");
    ...
    <div class="container">
     <!-- 面包屑导航 -->
            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="menuPro-second">
                        <a href="javascript:;" id="suppliers"><i class="fa fa-angle-right"></i>升级供应商</a>
                        <a href="javascript:;" id="procurement"><i class="fa fa-angle-right"></i>升级采购商</a>
        ...
        <div class="member-right">
         <iframe frameborder="0" name="lefra" id="lefra" src="front/right/vip2.jsp" width="100%"></iframe>
