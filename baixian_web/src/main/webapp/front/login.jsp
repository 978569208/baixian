...
<base href="<%=basepath %>" />
    ...
    $(function(){
    	...
    	$("#bt1").click(function () {
    		...
    		$.post("uc/islogin","&loginname="+$("#loginname").val()+"&loginpwd="+$("#loginpwd").val(),function(data){
        ...
        <div class="content-reg">
            ...
            <div class="login-form">
                ...
                <div class="login-right">
                    <form action="uc/islogin" id="loginform" name="loginform" method="post">
                        <div class="controls">
                            ...
                            <input type="text" name="loginname" id="loginname" class="input03 w400">
                        </div>
                        <div class="controls">
                            <div class="login-controls">
                                <p>密码：</p>
                            ...
                            <input type="text" name="loginpwd" id="loginpwd" class="input03 w400">
                        </div>
                        <div class="controls">
                            <div class="login-controls">
                                <p>验证码：</p>
                        ...
                        <div class="controls">
                            <input type="button" id="bt1" value="登录" class="btn07 w400">
                        </div>
                    </form>
                </div>
            </div>
